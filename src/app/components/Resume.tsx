  ...
  return (
    <div className="bg-[#fffbf5] text-black">
      <div className="container mx-auto p-4">
        <p className="text-3xl pr-20">
          Passionate software developer, always learning and building impactful
          projects.
        </p>
      </div>
      <div className="container mx-auto p-4">
      ...
      <div className="container mx-auto px-4 py-1">
        <p className="text-4xl py-4 text-center md:text-left">
          Working Experience
        </p>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="w-72 md:w-auto rounded-3xl bg-white border-2 border-black border-solid py-2 pl-3 flex flex-col md:grid md:grid-cols-[auto,auto,1fr] gap-3 md:mr-16 mb-2 mx-auto">
          <div className="w-16 h-16 bg-[#fffbf5] flex rounded-full items-center justify-center mx-auto md:mx-0">
            <Image src={EduLogo} alt="Book Image" className="w-12 h-12" />
          </div>
          <div className="flex flex-col justify-center text-center md:text-left">
            <p className="text-lg">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="w-72 md:w-auto rounded-3xl bg-white border-2 border-black border-solid p-4 flex flex-col md:flex-row items-center gap-3 md:mr-16 mb-2 mx-auto">
          ...
          <div className="w-full md:w-2/3 flex flex-col justify-center text-center md:text-left">
            <p className="text-lg">
              Trip planner application that uses artificial intelligence to
              learn the user and offer best-tailored activities to fit into
              their free time.
            </p>
            <p className="text-base font-bold mt-2">
              React Native, JavaScript/TypeScript, Tailwind CSS
            </p>
          </div>
        </div>
        <div className="w-72 md:w-auto rounded-3xl bg-white border-2 border-black border-solid p-4 flex flex-col md:flex-row items-center gap-3 md:mr-16 mb-2 mx-auto">
          ...
          <div className="w-full md:w-2/3 flex flex-col justify-center text-center md:text-left">
            <p className="text-lg">
              Website for a marketing company that manages the online reputation
        ...
        <div className="w-72 md:w-auto rounded-3xl bg-white border-2 border-black border-solid p-4 flex flex-col md:flex-row items-center gap-3 md:mr-16 mb-2 mx-auto">
          ...
          <div className="w-full md:w-2/3 flex flex-col justify-center text-center md:text-left">
            <p className="text-lg">
              A Wordle-inspired word game where players have six attempts to
              guess a hidden five-letter word.
            </p>
            <p className="text-base font-bold mt-2">Flutter, Dart</p>
          </div>
        </div>
      </div>
    </div>
